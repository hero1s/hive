...
timer_mgr:once(2000, function()
    local code, count = mongo_mgr:count("default", nil, "test_mongo_1", { pid = 123456, uid = 1 })
    log_debug("db count code: {}, count = {}", code, count)
    local icode, ierr = mongo_mgr:insert("default", nil, "test_mongo_1", { pid = 123456, uid = 2, data = { a = 1, b = 2 } })
    log_debug("db insert code: {}, err = {}", icode, ierr)
    icode, ierr = mongo_mgr:insert("default", nil, "test_mongo_1", { pid = 123457, uid = 0, data = { a = 1, b = 2 } })
    log_debug("db insert code: {}, err = {}", icode, ierr)
    local fcode, res = mongo_mgr:find("default", nil, "test_mongo_1", {}, { _id = 0 })
    ...
    fcode, res = mongo_mgr:find("default", nil, "test_mongo_1", {}, { _id = 0 }, { "uid", -1, "pid", 1, })
